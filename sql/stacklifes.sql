...
CREATE TABLE `sl_directory` (
  ...
  KEY `weight` (`weight`) USING BTREE,
  KEY `type_status` (`type`,`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=383 DEFAULT CHARSET=utf8mb3 COMMENT='菜单';
...
INSERT INTO `sl_directory` VALUES ('382', '371', null, '0', null, '', 'php', '0', '1', '0', null);
