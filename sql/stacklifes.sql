...
) ENGINE=InnoDB AUTO_INCREMENT=388 DEFAULT CHARSET=utf8mb3 COMMENT='菜单';
...
CREATE TABLE `sl_directory` (
  ...
  KEY `weight` (`weight`) USING BTREE,
  KEY `type_status` (`type`,`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=407 DEFAULT CHARSET=utf8mb3 COMMENT='菜单';

-- ----------------------------
-- Records of sl_directory
-- ----------------------------
INSERT INTO `sl_directory` VALUES ('377', '371', '1', '0', null, 'nicholas', 'redis', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('378', '371', '1', '0', null, 'nicholas', 'mysql', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('379', '371', '1', '0', null, 'nicholas', 'nginx', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('380', '371', '1', '0', null, 'nicholas', 'CI/CD', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('381', '371', '1', '0', null, 'nicholas', 'golang', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('382', '371', '1', '0', null, 'nicholas', 'php', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('383', '377', '1', '0', null, 'nicholas', '构建一个PHP框架', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('384', '372', '1', '0', null, 'nicholas', 'gin开发框架', '1', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('385', '375', '1', '0', null, 'nicholas', '索引', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('386', '375', '1', '0', null, 'nicholas', '事务', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('387', '373', '1', '0', null, 'nicholas', '后台开发', '1', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('388', '373', '1', '0', null, 'nicholas', 'api开发', '3', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('389', '373', '1', '0', null, 'nicholas', '数据清洗', '2', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('390', '373', '1', '0', null, 'nicholas', '架构设计', '4', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('391', '371', '1', '0', null, 'nicholas', 'MongoDB', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('392', '372', '1', '0', null, 'nicholas', '常用库', '2', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('393', '372', '1', '0', null, 'nicholas', 'GC机制', '3', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('394', '372', '1', '0', null, 'nicholas', 'GMP模型', '4', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('395', '372', '1', '0', null, 'nicholas', '协程', '5', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('396', '372', '1', '0', null, 'nicholas', '面向对象', '6', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('397', '378', '1', '0', null, 'nicholas', 'CDC', '1', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('398', '377', '1', '0', null, 'nicholas', '设计模式(PHP)', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('399', '375', '1', '0', null, 'nicholas', '锁', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('401', '370', '1', '0', null, 'nicholas', '事务处理', '0', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('402', '372', '1', '0', null, 'nicholas', '数据类型', '4', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('403', '373', '1', '0', null, 'nicholas', '业务分析', '5', '1', '0', null);
INSERT INTO `sl_directory` VALUES ('404', '373', '1', '0', null, 'nicholas', '分包机制', '0', '1', '0', null);
...
CREATE TABLE `sl_tags` (
  ...
  KEY `weight` (`weight`) USING BTREE,
  KEY `type_status` (`type`,`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=393 DEFAULT CHARSET=utf8mb3 COMMENT='菜单';
